...
const About = () => {
  return (
    <section id="about" className="w-full h-full md:h-screen flex items-center justify-center bg-transparent relative z-10 overflow-hidden pt-4 md:pt-0">
          ...
          <div className="w-full md:w-7/12 text-center md:text-left flex flex-col items-center md:items-start order-2">
            <ScrollReveal delay={0.2}>
              ...
              <div className="relative inline-flex items-center justify-center p-[1.5px] overflow-hidden rounded-full group scale-[0.75] origin-center md:scale-100 mb-3 md:mb-0">
                ...
                />
                <div className="relative z-10 flex items-center gap-2 px-4 py-1.5 md:px-8 md:py-3 bg-white dark:bg-[#0a0a0a] rounded-full border border-black dark:border-transparent">
                  ...
                  <span className="text-[9px] md:text-[10px] font-black text-black dark:text-white uppercase tracking-[0.3em] whitespace-nowrap">Available for work</span>
                </div>
              </div>
